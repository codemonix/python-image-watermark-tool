""" This module provide classes to create ad manage 
UI components like a progressbar and drag and drop window"""
...
class ProgressBar:
    def __init__(self, master, task_function, settings_container=None,
                  maximum=100, title_text=None) -> None:
        self.masetr = master
    ...
    def start_progress(self):
        ...
        self.progressbar = ttk.Progressbar(self.progress_window,
                            orient='horizontal', length=300, mode='determinate',
                            maximum=self.maximum,  variable=self.progress_var)
        self.progressbar.pack(padx=5, pady=10)
        self.cancel_button = tk.Button(self.progress_window, text="Cancel",
                                       command=self.cancel)
